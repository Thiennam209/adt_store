...
resource ingestfunction 'Microsoft.Web/sites/extensions@2015-08-01' = {
  ...
  properties: {
    packageUri: 'https://github.com/Thiennam209/adt_store/raw/main/functions/zipfiles/blade-functions.zip'
    dbType: 'None'
    connectionString: ''
  }
  dependsOn: [
...
resource PostDeploymentscript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    primaryScriptUri: 'https://raw.githubusercontent.com/Thiennam209/adt_store/main/postdeploy.sh'
